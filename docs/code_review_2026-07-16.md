...
> **后续修正（同日晚间）**：本报告的“P0 全部已修”只覆盖当时审查范围。`batch_0716_1331` 又确认了 Route 边界补线插入顺序错误、connection 折线被拉成弦线，以及孔洞诊断未闭环三项问题；实车参数也已从 demo 假设 `0.95/0.45` 校准为候选 `0.75/0.90`。继续修复前先读 [`diagnosis_batch_0716_1331.md`](diagnosis_batch_0716_1331.md)。
